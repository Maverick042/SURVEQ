    ...
    <div class="row">
        <div class="col-md-12">
            <div style="background-color: #34495e; text-align: center; color:white; padding: 10px; margin-top: 10px;text-transform: uppercase" >
                ...
                echo "<h2 style='color: white'>Quiz Name - ".$rows[0]['surveyName']. "</h2>";
    ...
    <div class="row">
        <div class="col-md-6">
            <div style="background-color: #ecf0f1;  margin-top: 10px; padding: 10px ">
                <form method="post" action="savequizquestion.php?id=<?php echo $_GET['id'] ?>">
                    ...
                    <hr>
                    <label>Enter Correct Answer no. </label>
                    <br>
